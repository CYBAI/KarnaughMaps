...
/**
 * TODO
 * Using Petrick's method when there's no essential prime implicants
 */
KarnaughMaps.prototype.petricksMethod = function () {
    _.forEach(this.primeImplicants, function (value, key) {
        console.log(value);
    });
};
